...
namespace slamware_ros_sdk
{
    ...
    private:
        ...
        // Software state machine for the relocalization status topic: terminal states
        // (Succeed/Failed/Canceled) are held for a short window, then fall back to None.
        std::string relocHeldTerminal_;
        std::chrono::steady_clock::time_point relocHoldStart_;
    };
