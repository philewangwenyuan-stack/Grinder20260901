...
class ObstacleAwareBoustrophedonPlanner:
    ...
    def _get_scan_segments(self, grid_map, poly, fixed_idx, start_idx, end_idx, is_row_scan,
        ...
        rows, cols = grid_map.shape
#修改路径间隔
        for moving_idx in range(start_idx, end_idx + 1, 3):
...
class MultiStagePathPlanner:
    ...
    def _plan_with_cpp_backend(self, inflated_grid, stages, real_to_grid_ratio, effective_spacing):
        if _mst26_cpp is None or os.environ.get("MST26_DISABLE_CPP") == "1":
            return None
        ...
        try:
            cpp_path = _mst26_cpp.plan_core(grid_for_cpp, stage_specs, spacing_pixels)
...
def demo_fixed():
    ...
    # 障碍物参数
    obstacle1 = [
        Point(row=360, col=150),
        Point(row=260, col=150),
        Point(row=260, col=290),
        Point(row=360, col=290)
    ]

    obstacle2 = [
        Point(row=690, col=650),
        Point(row=560, col=650),
        Point(row=560, col=820),
        Point(row=690, col=820)
    ]
    ...
    global_area = [
        Point(row=50, col=50),
        Point(row=50, col=950),
        Point(row=950, col=950),
        Point(row=950, col=650),
        Point(row=650, col=650),
        Point(row=650, col=350),
        Point(row=950, col=350),
        Point(row=950, col=50)
    ]

    # 阶段1区域
    stage1_poly = [
        Point(row=50, col=50),
        Point(row=50, col=350),
        Point(row=950, col=350),
        Point(row=950, col=50)
    ]
    ...
    stages = [
        StageConfig(
            ...
            start_point=Point(row=950, col=50),
            end_point=Point(row=70, col=350),
            direction='x',
            path_spacing=20.0,
        ...
        StageConfig(
            ...
            start_point=Point(row=50, col=420),
            end_point=Point(row=650, col=650),
            direction='y',
            path_spacing=20.0,
        ...
        StageConfig(
            ...
            start_point=Point(row=50, col=650),
            end_point=Point(row=950, col=950),
            direction='x',
            path_spacing=20.0,
            obstacle_polygons=[obstacle2]
        )
    ]
    ...
    print("\n" + "=" * 60)
    print(f"[运行时间] 路径规划耗时: {plan_elapsed:.4f} 秒")
    print(f"[运行时间] 总运行耗时: {demo_elapsed:.4f} 秒")
    print("=" * 60 + "\n")
